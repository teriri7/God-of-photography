...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 w-full px-3 py-1.5 flex items-center justify-between glass-panel border-b border-pink-200/40">
      {/* 极简左侧：小巧粉色呼吸圆点与图层数指示 */}
      <div className="flex items-center space-x-2">
        <div className="w-6 h-6 rounded-lg bg-gradient-to-tr from-pink-500 to-rose-400 flex items-center justify-center shadow-xs">
